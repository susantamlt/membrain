	        ...
	        <div class="well1 white">
				...
				<script type="text/javascript">
					$(document).ready(function() {
							/******** CSV file upload after user uploads the file  ********/						
							$('#fileuploader').uploadFile({
								...
								onSuccess : function(files,data,xhr) {
									...
									if(data.filename == '0' && data.status=='0') {
										$('#message').html("<ul class='error-success'><li class='success'>File name doesn't match with campaign ID</li></ul>").show();
									} else if(data.empty=='0' && data.status=='0') {
										$('#message').html('<ul class="error-success"><li class="success">CSV file is empty</li></ul>').show();
									} else if(data.delimiter = '0' && data.status=='0') {
										$('#message').html('<ul class="error-success"><li class="success">Couldn"t find Tab delimiter, CSV file is invalid.</li></ul>').show();
						...
						/******** END OF CSV file upload after user uploads the file  ********/
						...
						/******** ON SELECTING A CLIENT FETCHING CAMPAIGN RELATED TO THAT CLIENT  ********/
						...
						/******** END OF ON SELECTING A CLIENT FETCHING CAMPAIGN RELATED TO THAT CLIENT ********/
